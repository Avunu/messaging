    ...
    def send_newsletter(self, emails: list[str], test_email: bool = False):
        ...
        if test_email:
            ...
            if "newsletter" in installed_apps:
                email_read_tracker_url = "/api/method/newsletter.newsletter.doctype.newsletter.newsletter.newsletter_email_read"
            else:
                email_read_tracker_url = "/api/method/frappe.email.doctype.newsletter.newsletter.newsletter_email_read"
        ...
        for email in emails:
            ...
            email_args["message"] = self.get_message(
                medium="email", contact=contact_info
            )
